...
// NEW: Runtime rewrite toggle (Safety Layer)
...
void LoadConfig()
{
    ...
    // NEW: Runtime rewrite toggle
    g_enableRuntimeRewrite = GetPrivateProfileIntA("General", "bEnableRuntimeRewrite", 1, iniPath.c_str()) != 0;
